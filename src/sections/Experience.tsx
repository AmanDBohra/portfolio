...
export function Experience() {
  return (
    <section id="experience" className="section bg-slate-50/70 dark:bg-white/[0.02]">
      <div className="container-x">
        <SectionHeading
          index="02"
          eyebrow="Career"
          title="A career in analytics delivery"
          description="From hands-on BI development to leading enterprise analytics engagements."
        />
