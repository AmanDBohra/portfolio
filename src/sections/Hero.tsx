      ...
      <div className="container-x grid items-center gap-12 pb-16 lg:grid-cols-[1.15fr_0.85fr] lg:pb-24">
        ...
        <div>
          ...
          >
            ...
            <span className="animate-gradient bg-gradient-to-r from-brand-500 via-brand-400 to-teal-400 bg-[length:200%_auto] bg-clip-text text-transparent">
              Useful.
            </span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="mt-4 text-lg font-semibold text-slate-700 dark:text-slate-200"
          >
            Focused on{" "}
            <RotatingWord
              words={[
        ...
        >
          <div className="relative h-72 w-72 sm:h-96 sm:w-96">
            ...
            />
            {/* glow */}
            <div className="absolute inset-0 animate-float-slow rounded-full bg-brand-500/20 blur-2xl" />
